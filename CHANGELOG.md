...
- **Modulators**: LFO, Sample-and-Hold, and Slew Limiter processors
- **Utilities**: Windowed-sinc resampler with arbitrary sample rate conversion and bidirectional ResamplerPair for host/processing rate round-trips
