...
namespace PlayfulTones::DspToolBox
{
    ...
    public:
         ...
         */
        bool connect(AudioGraphNode::Id sourceId, AudioGraphNode::Id targetId, 
                     int outputChannel = 0, int inputChannel = 0)
        {
         ...
         */
        bool disconnect(AudioGraphNode::Id sourceId, AudioGraphNode::Id targetId,
                        int outputChannel = 0, int inputChannel = 0)
        {
            auto sourceIt = nodes.find(sourceId);
            auto targetIt = nodes.find(targetId);
